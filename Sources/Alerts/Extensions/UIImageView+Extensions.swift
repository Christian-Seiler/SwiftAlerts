...
extension UIImageView {
    ...
    /// Sets the image property of the view based on initial text,
    ...
    ///   - color: This optional paramter sets the background of the image.
    ///            By default, a random color will be generated.
...
extension UIImageView {
    ...
    func setImageForName(string: String,
                         backgroundColor: UIColor? = nil,
                         circular: Bool,
                         textAttributes: [NSAttributedString.Key: AnyObject]?,
                         gradient: Bool = false) {

        setImageForName(string: string,
    ...
    private func imageSnapshot(text imageText: String,
...
private func topAndBottomColors(for color: UIColor,
                                withTopOffset topOffset: HSVOffset = kGradientTopOffset,
                                withBottomOffset bottomOffset: HSVOffset = kGradientBotomOffset) -> GradientColors {
    let topColor = correctColorComponents(of: color, withHSVOffset: topOffset)
    let bottomColor = correctColorComponents(of: color, withHSVOffset: bottomOffset)
