...
public final class CollectionViewVideoCell: CollectionViewCustomContentCell<UIImageView> {
    ...
    override public func layoutSubviews() {
        ...
        videoDurationLabel?.frame = CGRect(origin: CGPoint(x: (bounds.maxX - bounds.width / 2) - videoDurationLabelMarginRight,
                                                           y: bounds.maxY - videoDurationLabelMarginBottom),
                                           size: CGSize(width: bounds.width / 2, height: videoDurationLabelHeight))
        gradientBackgroundImageView?.frame = CGRect(x: 0,
                                                    y: bounds.maxY - gradientBackgroundHeight,
                                                    width: bounds.width,
...
private extension CollectionViewVideoCell {
    ...
    func setupGradientBackground() {
        ...
        gradientBackgroundImageView = UIImageView(image: UIImage(named: "gradient_black_transparent",
                                                                 in: bundle,
                                                                 compatibleWith: nil))
