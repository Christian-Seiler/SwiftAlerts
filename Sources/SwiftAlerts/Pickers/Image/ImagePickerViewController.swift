...
extension UIAlertController {
    ...
    public func addImagePicker(flow: UICollectionView.ScrollDirection,
                               paging: Bool,
                               images: [UIImage],
                               selection: ImagePickerViewController.SelectionType? = nil) {
...
extension ImagePickerViewController: UICollectionViewDataSource {
    ...
    public func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        guard let item = collectionView.dequeueReusableCell(withReuseIdentifier: ItemWithImage.identifier,
                                                            for: indexPath) as? ItemWithImage else { return UICollectionViewCell() }
