...
public class ItemWithImage: UICollectionViewCell {
    ...
    func updateAppearance(forCircle view: UIView) {
        ...
        view.layer.shadowPath = UIBezierPath(roundedRect: unselectedCircle.bounds,
                                             byRoundingCorners: .allCorners,
                                             cornerRadii: CGSize(width: unselectedCircle.bounds.width / 2,
                                                                 height: unselectedCircle.bounds.width / 2)).cgPath
